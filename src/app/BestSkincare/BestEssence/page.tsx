...
const page = () => {
  ...
  const [hero, setHero] = useState({
    ...
    getOff: data.data.BestEssence.first.getOffBool
  })
  ...
  const SecondClick = () => {
    ...
    setHero({
      ...
      getOff: data.data.BestEssence.second.getOffBool
    })
  }
  ...
  const ThirdClick = () => {
    ...
    setHero({
      ...
      getOff: data.data.BestEssence.third.getOffBool
    })
  }
  ...
  const FourthClick = () => {
    ...
    setHero({
      ...
      getOff: data.data.BestEssence.fourth.getOffBool
    })
  }
  ...
  const FifthClick = () => {
    ...
    setHero({
      ...
      getOff: data.data.BestEssence.fifth.getOffBool
    })
  }
