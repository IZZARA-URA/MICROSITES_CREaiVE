...
const page = () => {
  ...
  const [hero, setHero] = useState({
    ...
    getOff: data.data.BestFragranceEveryday.first.getOffBool
  })
  ...
  const SecondClick = () => {
    ...
    setHero({
      ...
      getOff: data.data.BestFragranceEveryday.second.getOffBool
    })
  }
  ...
  const ThirdClick = () => {
    ...
    setHero({
      ...
      getOff: data.data.BestFragranceEveryday.third.getOffBool
    })
  }
  ...
  const FourthClick = () => {
    ...
    setHero({
      ...
      getOff: data.data.BestFragranceEveryday.fourth.getOffBool
    })
  }
  ...
  const FifthClick = () => {
    ...
    setHero({
      ...
      getOff: data.data.BestFragranceEveryday.fifth.getOffBool
    })
  }
      ...
      <div className="relative w-screen h-screen items-center text-center text-[200px] m-auto ">
        ...
        <div className='absolute z-50 right-1 hv:right-8 w-[20vw] hv:w-[250px] text-black top-[5vh] hv:top-[20vh] top-[20vh] hv:p-4 hv:pt-0 move-left-animation'>
          <div onClick={FirstClick} className='border-2 rounded-[20px] shadow-xl '>
            <img src={data.data.BestFragranceEveryday.first.image} className='hv:pt-4' />
            <div className='hidden hv:text-[14px] hv:pt-4 hv:px-2 font-sctoBold uppercase'>
              {data.data.BestFragranceEveryday.first.name}
            </div>
          </div>

          <div onClick={SecondClick} className='pt-4 mt-4  border-2 rounded-[20px] shadow-xl'>
            <img src={data.data.BestFragranceEveryday.second.image} className='hv:pt-4' />
            <div className='hidden hv:text-[14px] hv:pt-4 hv:px-2 font-sctoBold uppercase'>
              {data.data.BestFragranceEveryday.second.name}
            </div>
          </div>

          <div onClick={ThirdClick} className='pt-4 mt-4  border-2 rounded-[20px] shadow-xl'>
            <img src={data.data.BestFragranceEveryday.third.image} className='hv:pt-4' />
            <div className='hidden hv:text-[14px] hv:pt-4 hv:px-2 font-sctoBold uppercase'>
              {data.data.BestFragranceEveryday.third.name}
            </div>
          </div>

          <div onClick={FourthClick} className='pt-4 mt-4  border-2 rounded-[20px] shadow-xl'>
            <img src={data.data.BestFragranceEveryday.fourth.image} className='hv:pt-4' />
            <div className='hidden hv:text-[14px] hv:pt-4 hv:px-2 font-sctoBold uppercase'>
              {data.data.BestFragranceEveryday.fourth.name}
            </div>
          </div>

          <div onClick={FifthClick} className='pt-4 mt-4  border-2 rounded-[20px] shadow-xl'>
            <img src={data.data.BestFragranceEveryday.fifth.image} className='hv:pt-4' />
            <div className='hidden hv:text-[14px] hv:pt-4 hv:px-2 font-sctoBold uppercase'>
              {data.data.BestFragranceEveryday.fifth.name}
            </div>
          </div>
        </div>
        ...
        <div className='w-[55vw] h-auto m-auto appear-animetion'>
          <div className='relative m-auto pt-10 justify-center items-center text-center w-full text-black text-[15px] hv:text-[30px] uppercase font-sctoBold'>
            {data.dataPageTitle}: {data.data.BestFragranceEveryday.name}
          </div>
